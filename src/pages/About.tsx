          ...
          >
            ...
            <motion.div variants={itemVariants} className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Yazılım mühendisliği ve teknoloji tutkusuyla yenilikçi çözümler
                geliştiren bir geliştirici
              </p>
            </motion.div>
              ...
              <div className="md:col-span-2 space-y-12">
                ...
                >
                  ...
                  <p>
                    ...
                    beri teknolojinin sınırlarını keşfetmeye devam ediyorum. 10+
                    yıllık profesyonel deneyimim boyunca, küçük start-up'lardan
                    Fortune 500 şirketlerine kadar farklı ölçekteki
                    organizasyonlarda çalıştım.
                  </p>
                  <p>
                    Modern web uygulamaları, mobil çözümler ve bulut mimarileri
                    konusunda uzmanlık sahibiyim. Her projede kullanıcı
                    deneyimini ve performansı ön planda tutarak, ölçeklenebilir
                    ve sürdürülebilir kodlama pratikleri uyguluyorum.
                  </p>
                  <p>
                    Teknoloji topluluğuna katkıda bulunmayı seviyorum. Açık
                    kaynak projelere katkı sağlıyor, blog yazıları yazıyor ve
                    konferanslarda konuşmalar yapıyorum. Sürekli öğrenme ve
                    kendimi geliştirme tutkusuyla her zaman yeni teknolojileri
                ...
                <motion.div variants={itemVariants}>
                  <Tabs defaultValue="experience" className="w-full">
                    ...
                    <TabsContent value="experience" className="space-y-4">
                      <Card className="border-gray-300 bg-white  hover:bg-blue-400/10 transition-all duration-300 hover:border-blue-400 hover:text-primary">
                        <CardContent className="pt-6">
                          ...
                          <p className="text-muted-foreground">
                            Mikroservis mimarileri tasarlama ve uygulama, büyük
                            ölçekli sistemler geliştirme ve teknik liderlik.
                            Cloud-native uygulamalar için en iyi pratikleri
                            uygulama ve teknik ekibi yönetme.
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="border-gray-300 bg-white  hover:bg-blue-400/10 transition-all duration-300 hover:border-blue-400 hover:text-primary">
                        <CardContent className="pt-6">
                          ...
                          <p className="text-muted-foreground">
                            Modern web uygulamaları geliştirme, API tasarımı ve
                            implementasyonu, veritabanı optimizasyonu ve CI/CD
                      ...
                      <Card className="border-gray-300 bg-white  hover:bg-blue-400/10 transition-all duration-300 hover:border-blue-400 hover:text-primary">
                        <CardContent className="pt-6">
                          ...
                          <p className="text-muted-foreground">
                            Frontend ve backend geliştirme, kullanıcı arayüzü
                            tasarımı, veritabanı yönetimi ve müşteri iletişimi.
                          </p>
                        </CardContent>
                      </Card>
                    </TabsContent>
                    ...
                    <TabsContent value="education" className="space-y-4">
                      <Card className="border-gray-300 bg-white  hover:bg-blue-400/10 transition-all duration-300 hover:border-blue-400 hover:text-primary">
                        <CardContent className="pt-6">
                          ...
                          <h4 className="text-primary mb-4">
                            Modern Teknoloji Üniversitesi
                          </h4>
                          <p className="text-muted-foreground">
                            Yapay zeka ve makine öğrenmesi odaklı, gerçek hayat
                            problemlerine çözümler geliştirme üzerine projeler.
                            3.85/4.00 not ortalaması ile mezun oldum.
                          </p>
                        </CardContent>
                      </Card>
                      ...
                      <Card className="border-gray-300 bg-white  hover:bg-blue-400/10 transition-all duration-300 hover:border-blue-400 hover:text-primary">
                        <CardContent className="pt-6">
                          ...
                          <p className="text-muted-foreground">
                            Veri yapıları, algoritma analizi, yazılım
                            mühendisliği, veritabanı sistemleri ve bilgisayar
                            ağları üzerine kapsamlı eğitim. Bölüm birincisi
                            olarak mezun oldum.
                          </p>
                        </CardContent>
                      </Card>
                    ...
                    <TabsContent value="skills">
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                        <Card className=" bg-white border-gray-200  hover:bg-blue-400/10 transition-all duration-300 hover:border-blue-400 hover:text-primary">
                ...
                <motion.div variants={itemVariants}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Card className="border-gray-300 bg-white backdrop-blur-sm">
                      <CardContent className="p-6">
                        ...
                        <p className="text-muted-foreground text-sm">
                          AWS platformunda güvenli ve ölçeklenebilir uygulamalar
                          tasarlama ve geliştirme uzmanlığı.
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-gray-300 bg-white backdrop-blur-sm">
                      <CardContent className="p-6">
                        <h3 className="font-bold text-lg mb-1">
                          Google Cloud Profesyonel Mühendis
                        </h3>
                        <p className="text-primary text-sm mb-2">
                          Google Cloud Platform, 2021
                        </p>
                        <p className="text-muted-foreground text-sm">
                          GCP'de uygulama tasarımı, geliştirme ve optimize etme
                          yetkinliği sertifikası.
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-gray-300 bg-white backdrop-blur-sm">
                      <CardContent className="p-6">
                        <h3 className="font-bold text-lg mb-1">
                          Tensorflow Geliştirici Sertifikası
                        </h3>
                        <p className="text-primary text-sm mb-2">
                          Google, 2020
                        </p>
                        <p className="text-muted-foreground text-sm">
                          Makine öğrenmesi modellerini tasarlama ve uygulamada
                          yetkinlik.
                        </p>
                      </CardContent>
                    </Card>
                    ...
                    <Card className="border-gray-300 bg-white backdrop-blur-sm">
                      <CardContent className="p-6">
                        <h3 className="font-bold text-lg mb-1">
                          Yılın Geliştiricisi Ödülü
                        </h3>
                        <p className="text-primary text-sm mb-2">
                          TechFuture Inc., 2021
                        </p>
                        <p className="text-muted-foreground text-sm">
                          Yenilikçi çözümler ve şirket büyümesine katkılar için
                          takdir ödülü.
                        </p>
                      </CardContent>
                    </Card>
